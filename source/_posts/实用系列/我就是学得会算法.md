...
起因是两年前，《数据结构》及格了；《离散数学》及格了；《线性代数》在第四次及格了；《算法》也在第二次及格了。这四门课统称四小拦路蚂蚁。可以说是什么都及格了，太不拉胯了。

和写算法代码相比，写论文综述有意思、简单多了。因为你不只需要明白道理，还需要把它实现出来。当然这同时指的是前两件事。

<!--more-->

## 算法学得会的原因

不仅仅是算法，把这个套到其他事情上面也是一样：因为**你明白基础概念**。比如写二分查找，**你知道二分查找用几个指针**，人家是摸着石头过河，你也是。你的大部分时间都节省在：我**不从头开始想**，我应该怎么实现它，而是先**看**一遍别人的代码，看明白之后再**背**一遍。或者当你看别人的代码的时候，你会发现你还是看得懂：为什么看得懂？因为**你知道这个算法到底是用来干什么的**。当你自己想得出来，看别人代码也看得懂，又愿意看基础概念的时候，你就不会怀疑自已的能力，然后**_打破一个循环_**：为什么我写不出来？
